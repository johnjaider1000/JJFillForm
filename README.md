    ...
    <body>
        <section>
            <div class="container">
                ...
                <a href="JJFillForm.rar" class="btn btn-primary"><i class="glyphicon glyphicon-download-alt"></i> DESCARGAR</a>
                <hr/>                
                <div class="row">
                    <div class="col-xs-6">
                ...
                <div class="panel-body text-right">
                    Autor: <a href="http://jhonjaider1000.com" target="_blank"><img src="assets/favicon.png" class="m-l-5" width="20" /> jhonjaider1000</a>
                </div>
            </div>
        </section>
